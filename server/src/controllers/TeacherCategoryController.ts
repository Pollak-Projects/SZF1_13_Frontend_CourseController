...
import {z} from "zod";
import TeacherCategoryDTOs from "@/dtos/TeacherCategoryDTOs.ts";

const log = logger("teacher:category")

const orm = new PrismaClient()

export default class TeacherCategoryController {

    async createCategory(req: Request, res: Response) {
        log.http("Creating new category")

        const category: z.infer<typeof TeacherCategoryDTOs.createCategoryDTO> = req.body
    ...
    async updateCategory(req: Request, res: Response) {
        ...
        const category: z.infer<typeof TeacherCategoryDTOs.updateCategoryDTO> = req.body
