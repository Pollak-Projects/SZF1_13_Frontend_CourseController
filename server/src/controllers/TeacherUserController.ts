...
import TeacherUserDTOs from "@/dtos/TeacherUserDTOs.ts";
import {z} from "zod";

const log = logger("teacher:user")

const orm = new PrismaClient()

export default class TeacherUserController {

    async createUser(req: Request, res: Response)  {
        log.http("Adding new user")

        const user: z.infer<typeof TeacherUserDTOs.createUserDTO> = req.body
    ...
    async updateUser(req: Request, res: Response) {
        ...
        const user: z.infer<typeof TeacherUserDTOs.updateUserDTO> = req.body
