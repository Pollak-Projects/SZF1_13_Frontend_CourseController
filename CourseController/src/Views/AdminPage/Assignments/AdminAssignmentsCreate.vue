...
let formData = reactive({
  ...
  selectedGrade: null,
  assignemntName: null,
  assignemntDescription: null,
  assignemntMarkdownFile: null
});
...
const logger = () => {
  ...
  console.log(formData.assignemntName)
  console.log(formData.assignemntDescription)
  console.log(formData.assignemntMarkdownFile)
}
  ...
  <div class="flex flex-col gap-[10vh] sm:gap-[15vh] md:gap-[20vh]">
    ...
    <div
      ...
      <div class="flex flex-col gap-[3vh] sm:gap-[4vh] md:gap-[5vh] mb-[5vh]">
        <p class="place-self-center text-lg sm:text-xl md:text-4xl">Feladat Létrehozás</p>
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-y-[3vh] gap-x-[3vw]">
          ...
          <AdminModule style="height: 60px;"
            ...
            content="Feladat neve" />

          <AdminModule style="height: 60px;"
            class="rounded-lg p-4 sm:text-lg md:text-xl shadow-xl shadow-black/50 bg-black/40 text-white"
            content="Feladat leirasa" />
