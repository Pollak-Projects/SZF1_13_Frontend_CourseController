...
const tasks = [
  ...
  { id: 3, title: 'Big Tananyag 3', content: ['Content for dropdown 3', 'More content for dropdown 3', 'Even more content for dropdown 3'] },
];
...
.toggle-button {
  ...
  transform: translateY(-50%) rotate(180deg); /* Kezdetben 180 fokkal elforgatva */
  background: transparent;
  border: none;
  font-size: 24px;
  color: #d346f0;
  cursor: pointer;
  transition: transform 0.3s ease-in-out; /* Hozzáadjuk a sima animációt */
}

.toggle-button.rotated {
  transform: translateY(-50%); /* 90 fokos forgatás */
}
